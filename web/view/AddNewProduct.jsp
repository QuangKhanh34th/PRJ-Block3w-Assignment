<%-- 
    ...
    Created on : Apr 27, 2025, 5:11:23 PM
    Author     : ASUS
--%>
...
<html>
    <head>
        ...
        <title>Add New Product - Game Shop</title>
        <style>
            body {
        ...
        <div class="container">
            ...
            <form action="MainController?action=addProduct" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="prodQuantity" name="prodQuantity" min="0" value="0" required>
                </div>
                <div class="form-group">
                    <label for="prodPrice">Product Price:</label>
                    <input type="number" id="prodPrice" name="prodPrice" min="0.01" step="0.01" value="0.00" required>
                </div>
